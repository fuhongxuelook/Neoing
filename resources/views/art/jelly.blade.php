...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-5MCNF88');
    </script>
...
<body>
    ...
    <noscript>
        &lt;iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5MCNF88"
...
<section id="detail_index" class="clearfix">
        ...
        <section class="msgowl abs100">
            ...
            <section class="goodsInfo">
                ...
                <div class="detail">
                    <div class="baseInfo">
                        <p class="name">
                            <a href="https://www.ywart.com/artist/1350dd" target="_blank">刘川</a>
                        ...
                        <p class="infos">
                            <span class="mingcheng">角落</span>
                            <span class="createdate">2017</span>
                            <span class="caizhi">布面丙烯</span>
                            <span class="chicun">120x100cm</span>
                            <span class="nianfen"></span>
                        </p>
                    </div>
                    <div class="tuijian">
                        <p>编辑推荐</p>
                        <p>细腻的、看似没有秩序的笔触在画布上呈现着现实景象的另一种观看方式，它们如被蒙上一层不断变化的情绪，静止的事物便像被赋予生命一般，在热闹而安静的角落，跳跃着自己的脚步。</p>
                        <br>
                        <span>
                                ——桑榆未晚
                        </span>
    ...
    <section class="workInformation clearfix">
        ...
        <div class="workDes" style="display: block;">
            ...
            <i>
                细腻的、看似没有秩序的笔触在画布上呈现着现实景象的另一种观看方式，它们如被蒙上一层不断变化的情绪，静止的事物便像被赋予生命一般，在热闹而安静的角落，跳跃着自己的脚步。
                <br>
                <span>
                        ——桑榆未晚
                </span>
    ...
    <section class="detail_bottom clearfix">
        <section class="arterOther clearfix">
            <div class="arter">
                ...
                <p class="another"><a href="https://www.ywart.com/artist/1350dd" target="_blank">共<span class="artworkcount">6</span>件作品</a></p>
            </div>
                <div class="artWorks">
                    ...
                    <div class="otherDes">
                        <p><a href="https://www.ywart.com/artworks/1reekp">无题 1</a></p>
                        <p>
                            <span>综合材料</span><span>60x50cm</span>
                            <span>
                                2015
                            </span>
                        </p>
                        
        <p class="price">¥9,050</p>
                ...
                <div class="artWorks">
                    ...
                    <div class="otherDes">
                        <p><a href="https://www.ywart.com/artworks/11vjm2">赏石</a></p>
                        <p>
                            <span>布面丙烯</span><span>100x80cm</span>
                            <span>
                                2016
                            </span>
                        </p>
                        
        <p class="price">¥24,350</p>
                ...
                <div class="artWorks">
                    ...
                    <div class="otherDes">
                        <p><a href="https://www.ywart.com/artworks/1p7818">无题</a></p>
                        <p>
                            <span>布面丙烯</span><span>100x80cm</span>
                            <span>
                                2016
...
<script id="tem-framebox" type="text/html">
    <% for(var i= 0; i
    <list.length; i++){
                  var item=list[i].ArtworkFrame; %>
        <span data-i="<%=i%>" class="framestyle<%= i %>" style="background-image:url(https://cdn.ywart.com/artwork_frame/frame/<%=item.SampleImg%>@0-0-<%= item.A1Width+item.B1Width %>-<%= item.A1Height+item.B4Height %>a.png)"></span>
        <% } %>
</script>

<script id="tem-paddingbox" type="text/html">
    <%if(list.length>0){%>
    ...
    <list.length; i++){
                  var item=list[i]; %>
        <span data-i="<%=i%>" class="paddingstyle<%=i%>"><%= item.Name%></span>
        <% } %>
</script>
        ...
        <div class="page_login_box">
            ...
            <div class="page_login_dialog">
                ...
                <section class="login_dialog">
                    ...
                    <p class="hasanother">还没有账号？<span>请注册</span></p>
                    ...
                    <div class="login_third">
                        <a href="https://www.ywart.com/Auth/WeiboLogin?" target="_blank" id="weibo">
                            <i class="fa fa-weibo"></i>
                        </a>
                        <a href="https://www.ywart.com/Auth/WeixinLogin?" id="weixin"><i class="fa fa-weixin"></i></a>
                        <a href="javascript:void(0)" onclick="FBLogin()"><i class="fa fa-facebook"></i></a>
                    </div>
                </section>
                <section class="register_phone_dialog _hidden">
                    <div class="account inputdiv">
                        <p>请输入手机号或邮箱</p>
                        <input class="phone" type="tel" autocomplete="off">
                        <div class="line"></div>
                        <span class="tip"></span>
                    </div>
                    <div class="imgcode">
                        <input type="text" placeholder="请输入验证码" autocomplete="off">
                        <img class="codeimg_login" src="../artNet/img/GetLoginCaptcha">
                        <span class="tip"></span>
                    </div>
                    <div class="phonecode _hidden">
                        <input type="text" placeholder="短信验证码" autocomplete="off">
                        <button class="code_sms">获取短信验证码</button>
                        <span class="tip"></span>
                        <div class="_hidden"><span>未收到短信?</span><span class="code_phone">获取语音验证</span></div>
                    </div>
                    <div class="password inputdiv">
                        <p>请输入6-16位密码</p>
                        <input type="password" autocomplete="off">
    ...
    <script>
    var inject_data = {"artwork_code":"1qvw7d","artist_code":"1350dd","agent_code":"","has_add_cart":false,"has_add_wishlist":false,"is_sold":0,"is_simple_show":false,"is_allow_rebid":false,"artworkimgs":[{"file_name":"20171106132355226c63d5096.jpg","size_width":120.00,"size_height":100.00,"pixel_width":4048,"pixel_height":3383,"is_main":true,"is_detail_img":false}],"list_scene":[{"Id":2,"BgName":"北欧 中幅 客厅 沙发 落地灯 小桌 棕黄色系","FileName":"20160714002_150-200.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1125,"SizeWidth":642.90,"SizeHeight":0.00,"CenterLeft":896,"CenterTop":334,"ArtworkWidthMin":79.10,"ArtworkWidthMax":158.20,"ArtworkHeightMin":70.10,"ArtworkHeightMax":140.20,"Memo":"（横）截掉窗地毯截掉横幅2m以内（多用）b.jpg","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-07-14 10:57:38","UpdateTime":"2016-10-28 14:46:57"},{"Id":19,"BgName":"混搭 中幅 卧室 床 床头柜","FileName":"20160717012.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1125,"SizeWidth":519.00,"SizeHeight":0.00,"CenterLeft":989,"CenterTop":476,"ArtworkWidthMin":100.00,"ArtworkWidthMax":151.00,"ArtworkHeightMin":80.00,"ArtworkHeightMax":117.00,"Memo":"截床","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-07-17 16:03:06","UpdateTime":"2016-10-28 16:21:24"},{"Id":22,"BgName":"北欧 中幅 客厅 沙发 落地灯 小桌 棕黄色系","FileName":"20160717015.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1125,"SizeWidth":613.00,"SizeHeight":0.00,"CenterLeft":969,"CenterTop":307,"ArtworkWidthMin":120.00,"ArtworkWidthMax":180.00,"ArtworkHeightMin":90.00,"ArtworkHeightMax":140.00,"Memo":"P掉相框放横大画b","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-07-17 16:32:45","UpdateTime":"2016-10-28 16:06:57"},{"Id":27,"BgName":"美式 中幅 书房 沙发 落地灯 灰色墙","FileName":"20160717020.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1125,"SizeWidth":320.00,"SizeHeight":0.00,"CenterLeft":469,"CenterTop":413,"ArtworkWidthMin":80.00,"ArtworkWidthMax":140.00,"ArtworkHeightMin":60.00,"ArtworkHeightMax":100.00,"Memo":"shutterstock_253334857b","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-07-17 20:04:40","UpdateTime":"2016-10-28 16:16:55"},{"Id":32,"BgName":"北欧 中幅 客厅 沙发 落地灯 黄墙","FileName":"20160720005.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1333,"SizeWidth":411.00,"SizeHeight":0.00,"CenterLeft":1520,"CenterTop":500,"ArtworkWidthMin":90.00,"ArtworkWidthMax":152.00,"ArtworkHeightMin":80.00,"ArtworkHeightMax":145.00,"Memo":"切掉上方和右边b","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-07-20 18:56:55","UpdateTime":"2016-10-28 16:20:28"},{"Id":33,"BgName":"美式 大幅 书房 蓝色墙","FileName":"20160721001.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1125,"SizeWidth":523.00,"SizeHeight":0.00,"CenterLeft":1339,"CenterTop":397,"ArtworkWidthMin":100.00,"ArtworkWidthMax":200.00,"ArtworkHeightMin":100.00,"ArtworkHeightMax":155.00,"Memo":"shutterstock_185394059b","LimitArtworkStyle":"|抽象|抽象表现|写实|具象表现|观念艺术|卡通|超现实|工笔|其他|","IsDel":false,"CreateTime":"2016-07-21 14:41:15","UpdateTime":"2016-10-28 16:23:16"},{"Id":37,"BgName":"北欧 中幅 儿童房 蓝色墙","FileName":"20160721005.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1125,"SizeWidth":518.00,"SizeHeight":0.00,"CenterLeft":1204,"CenterTop":331,"ArtworkWidthMin":100.00,"ArtworkWidthMax":166.00,"ArtworkHeightMin":70.00,"ArtworkHeightMax":110.00,"Memo":"摆件p掉-地板截掉b","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-07-21 17:03:23","UpdateTime":"2016-10-28 16:26:49"},{"Id":40,"BgName":"简约 大幅 阁楼 白墙","FileName":"20160721008.jpg","StorageCode":"SceneBackground","ImgWidth":1920,"ImgHeight":1080,"SizeWidth":508.00,"SizeHeight":0.00,"CenterLeft":1072,"CenterTop":514,"ArtworkWidthMin":120.00,"ArtworkWidthMax":180.00,"ArtworkHeightMin":100.00,"ArtworkHeightMax":160.00,"Memo":"shutterstock_400596694 拷贝","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-07-21 20:54:05","UpdateTime":"2016-10-28 16:40:18"},{"Id":53,"BgName":null,"FileName":"20160803009.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1376,"SizeWidth":445.00,"SizeHeight":0.00,"CenterLeft":612,"CenterTop":570,"ArtworkWidthMin":60.00,"ArtworkWidthMax":120.00,"ArtworkHeightMin":80.00,"ArtworkHeightMax":160.00,"Memo":"4b","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-08-03 15:01:57","UpdateTime":"2016-08-03 15:01:57"},{"Id":56,"BgName":null,"FileName":"20160803012.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1045,"SizeWidth":777.00,"SizeHeight":0.00,"CenterLeft":1012,"CenterTop":322,"ArtworkWidthMin":110.30,"ArtworkWidthMax":220.70,"ArtworkHeightMin":70.70,"ArtworkHeightMax":141.40,"Memo":"5a-01","LimitArtworkStyle":"|抽象|抽象表现|写实|具象表现|观念艺术|卡通|超现实|工笔|其他|","IsDel":false,"CreateTime":"2016-08-03 15:51:11","UpdateTime":"2017-02-10 17:50:08"},{"Id":58,"BgName":null,"FileName":"20160803014.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1333,"SizeWidth":530.00,"SizeHeight":0.00,"CenterLeft":1094,"CenterTop":546,"ArtworkWidthMin":71.00,"ArtworkWidthMax":142.00,"ArtworkHeightMin":52.50,"ArtworkHeightMax":104.90,"Memo":"6b","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-08-03 16:06:38","UpdateTime":"2017-02-14 17:29:33"},{"Id":60,"BgName":null,"FileName":"20160803015.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1153,"SizeWidth":510.20,"SizeHeight":0.00,"CenterLeft":991,"CenterTop":550,"ArtworkWidthMin":62.20,"ArtworkWidthMax":124.50,"ArtworkHeightMin":99.50,"ArtworkHeightMax":199.00,"Memo":"6c","LimitArtworkStyle":"|抽象|抽象表现|写实|具象表现|观念艺术|卡通|超现实|工笔|其他|","IsDel":false,"CreateTime":"2016-08-03 16:17:45","UpdateTime":"2017-02-14 17:25:08"},{"Id":64,"BgName":null,"FileName":"20160803018.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1158,"SizeWidth":566.60,"SizeHeight":0.00,"CenterLeft":1121,"CenterTop":391,"ArtworkWidthMin":101.70,"ArtworkWidthMax":203.40,"ArtworkHeightMin":64.90,"ArtworkHeightMax":129.80,"Memo":"7b","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-08-03 16:38:35","UpdateTime":"2017-02-13 11:08:59"},{"Id":65,"BgName":"混搭 中幅 客厅 棕色墙面","FileName":"20160803019.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1055,"SizeWidth":524.00,"SizeHeight":0.00,"CenterLeft":973,"CenterTop":310,"ArtworkWidthMin":100.00,"ArtworkWidthMax":227.00,"ArtworkHeightMin":50.00,"ArtworkHeightMax":100.00,"Memo":"7c","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-08-03 16:44:09","UpdateTime":"2016-10-28 17:56:45"},{"Id":67,"BgName":"混搭 大幅 大厅","FileName":"20160803020.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1078,"SizeWidth":489.00,"SizeHeight":0.00,"CenterLeft":1294,"CenterTop":408,"ArtworkWidthMin":70.00,"ArtworkWidthMax":140.00,"ArtworkHeightMin":92.00,"ArtworkHeightMax":160.00,"Memo":"8c-01","LimitArtworkStyle":"","IsDel":false,"CreateTime":"2016-08-03 16:53:07","UpdateTime":"2016-10-28 19:06:02"},{"Id":96,"BgName":"混搭 大幅 客厅  浅灰色沙发 深色墙 造型背景墙","FileName":"2016093014025013461d47261.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1200,"SizeWidth":416.00,"SizeHeight":0.00,"CenterLeft":1001,"CenterTop":377,"ArtworkWidthMin":95.10,"ArtworkWidthMax":190.10,"ArtworkHeightMin":58.40,"ArtworkHeightMax":116.90,"Memo":"背景墙有造型","LimitArtworkStyle":"|抽象|抽象表现|写实|具象表现|观念艺术|超现实|工笔|写意|实验水墨|其他|","IsDel":false,"CreateTime":"2016-09-30 14:03:43","UpdateTime":"2016-10-28 17:08:39"},{"Id":98,"BgName":"简约 大幅 办公室 跃层 淡雅 办公 楼梯","FileName":"201610121333182249e04c274.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1200,"SizeWidth":647.50,"SizeHeight":0.00,"CenterLeft":982,"CenterTop":512,"ArtworkWidthMin":90.00,"ArtworkWidthMax":180.00,"ArtworkHeightMin":76.40,"ArtworkHeightMax":152.80,"Memo":"梯子","LimitArtworkStyle":"|抽象|抽象表现|写实|具象表现|观念艺术|卡通|超现实|工笔|写意|实验水墨|行书|草书|隶书|篆书|楷书|其他|","IsDel":false,"CreateTime":"2016-10-12 12:40:59","UpdateTime":"2016-10-28 17:01:11"},{"Id":104,"BgName":"地中海 中幅 大堂 蓝色 黄色墙","FileName":"201610131859346438aba7eff.jpg","StorageCode":"SceneBackground","ImgWidth":2500,"ImgHeight":1500,"SizeWidth":641.30,"SizeHeight":0.00,"CenterLeft":1286,"CenterTop":458,"ArtworkWidthMin":114.50,"ArtworkWidthMax":228.90,"ArtworkHeightMin":77.60,"ArtworkHeightMax":155.20,"Memo":"客厅","LimitArtworkStyle":"|抽象|抽象表现|写实|具象表现|观念艺术|卡通|超现实|工笔|写意|实验水墨|行书|草书|隶书|篆书|楷书|","IsDel":false,"CreateTime":"2016-10-13 18:38:26","UpdateTime":"2016-10-28 16:57:01"},{"Id":105,"BgName":"混搭 大幅 玄关 深色 实木","FileName":"201610141153070224e8e732e.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1200,"SizeWidth":470.60,"SizeHeight":0.00,"CenterLeft":752,"CenterTop":543,"ArtworkWidthMin":107.80,"ArtworkWidthMax":215.50,"ArtworkHeightMin":98.60,"ArtworkHeightMax":197.20,"Memo":"玄关","LimitArtworkStyle":"|抽象|抽象表现|写实|具象表现|观念艺术|卡通|超现实|工笔|写意|实验水墨|行书|草书|隶书|篆书|楷书|其他|","IsDel":false,"CreateTime":"2016-10-14 11:49:24","UpdateTime":"2017-02-13 11:00:03"},{"Id":106,"BgName":"混搭 大幅 办公室 实木 工作台 理性","FileName":"20161014133013802bc462134.jpg","StorageCode":"SceneBackground","ImgWidth":2500,"ImgHeight":1500,"SizeWidth":476.20,"SizeHeight":0.00,"CenterLeft":1768,"CenterTop":428,"ArtworkWidthMin":114.30,"ArtworkWidthMax":228.60,"ArtworkHeightMin":58.10,"ArtworkHeightMax":116.20,"Memo":"浅色墙体 木色家具","LimitArtworkStyle":"|抽象|抽象表现|写实|具象表现|观念艺术|超现实|工笔|写意|实验水墨|行书|草书|隶书|篆书|楷书|","IsDel":false,"CreateTime":"2016-10-14 13:31:55","UpdateTime":"2016-10-28 16:55:19"},{"Id":108,"BgName":"美式 小幅 卧室 深色 书桌前","FileName":"2016101414500773715f4cc38.jpg","StorageCode":"SceneBackground","ImgWidth":2300,"ImgHeight":1400,"SizeWidth":519.00,"SizeHeight":0.00,"CenterLeft":1050,"CenterTop":484,"ArtworkWidthMin":64.60,"ArtworkWidthMax":129.20,"ArtworkHeightMin":56.80,"ArtworkHeightMax":113.70,"Memo":"卧室","LimitArtworkStyle":"|抽象|抽象表现|写实|具象表现|观念艺术|卡通|超现实|工笔|写意|实验水墨|行书|草书|隶书|篆书|楷书|其他|","IsDel":false,"CreateTime":"2016-10-14 14:52:05","UpdateTime":"2017-02-23 14:45:43"},{"Id":115,"BgName":"儿童床 木质床","FileName":"20161114182737032320dd73b.jpg","StorageCode":"SceneBackground","ImgWidth":2000,"ImgHeight":1200,"SizeWidth":407.20,"SizeHeight":0.00,"CenterLeft":1108,"CenterTop":362,"ArtworkWidthMin":69.20,"ArtworkWidthMax":138.40,"ArtworkHeightMin":50.10,"ArtworkHeightMax":100.20,"Memo":"男孩","LimitArtworkStyle":"|抽象|抽象表现|写实|具象表现|卡通|超现实|工笔|写意|实验水墨|行书|草书|隶书|篆书|楷书|","IsDel":false,"CreateTime":"2016-11-14 18:23:58","UpdateTime":"2017-02-10 17:55:39"},{"Id":118,"BgName":"客厅","FileName":"201703061614036801efd7b60.jpg","StorageCode":"SceneBackground","ImgWidth":2500,"ImgHeight":1406,"SizeWidth":847.50,"SizeHeight":0.00,"CenterLeft":885,"CenterTop":558,"ArtworkWidthMin":66.10,"ArtworkWidthMax":132.20,"ArtworkHeightMin":79.70,"ArtworkHeightMax":159.30,"Memo":null,"LimitArtworkStyle":"|抽象|抽象表现|写实|具象表现|观念艺术|卡通|超现实|工笔|实验水墨|行书|草书|隶书|篆书|楷书|","IsDel":false,"CreateTime":"2017-03-06 16:09:35","UpdateTime":"2017-03-06 16:14:08"}],"list_frame":[],"isOnlyOneFrameAndPadding":false};
